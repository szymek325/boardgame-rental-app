...
{
    internal class
        GetAllRentalsForBoardGameQueryHandler : IQueryHandler<GetAllRentalsForBoardGameQuery, IList<Core.Models.Rental>>
    {
        ...
        public async Task<IList<Core.Models.Rental>> Handle(GetAllRentalsForBoardGameQuery query,
