...
namespace Playingo.Application.Tests.Rentals.Commands
{
    public class AddGameRentalCommandHandlerTests
    {
        ...
        {
            _validator = new Mock<IValidator<Rental>>(MockBehavior.Strict);
        ...
        private readonly Mock<IValidator<Rental>> _validator;
        ...
        public void Handle_Should_ThrowBoardGameNotFoundException_When_ReturnedBoardGameIsNull(bool canBeRented)
        {
            _validator.Setup(
                    x => x.Validate(
                        It.Is((Rental rental) => rental.Id == _inputCommand.NewGameRentalGuid)))
        ...
        public async Task Handle_Should_AddAndSaveRental_When_ValidationIsPassedAndGameCanBeRented()
        {
            ...
            _unitOfWork.Verify(
                x => x.RentalRepository.AddAsync(It.IsAny<Rental>(), cancellationToken),
                Times.Once);
        ...
        public void Handle_Should_ThrowCustomValidationException_When_ValidatorReturnsValidationErrors()
        {
            ...
            _validator.Setup(x =>
                    x.Validate(It.Is((Rental gameRental) =>
